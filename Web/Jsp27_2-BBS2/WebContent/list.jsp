	...
	<table class="table table-hover table-striped table-dark  shadow p-3 mb-5 rounded">
		<thead class="bg-danger">
			<tr>
				<th>번호</th>
				<th>이름</th>
				<th class="w-75 align-middle">제목</th>
				<th>날짜</th>
				<th>히트</th>
			</tr>
		</thead>
		...
		<tr>
			...
			<td>
				...
				<a href="content_view.do?bId=${dto.bId}" class="text-white Stretched link">${dto.bTitle}</a>
			</td>
			<td>${dto.bDate}</td>
			<td>${dto.bHit}</td>
		</tr>
		...
		<tr>
			<td colspan ="5"><a href="write_view.do" class="btn btn-danger btn-lg btn-block">글작성</a></td>
		</tr>
		<tr>
			<td colspan ="5">
				<ul class="pagination justify-content-center pagination-lg" >
					...
					<c:otherwise>
						<li class="page-item"><a class="page-link" href="list.do?page=${page.curPage -1}">&lt;</a></li>
					</c:otherwise>
					</c:choose>
					<!--  개별 페이지 -->
					...
					<c:otherwise>
						<li class="page-item"><a class="page-link" href="list.do?page=${page.totalPage}">&gt;&gt;</a></li>
					</c:otherwise>
					</c:choose>
			   	</ul>
			</td>
