package com.study.android.ex43;
...
public class MainActivity extends AppCompatActivity {
    ...
    PhoneStateListener listener = new PhoneStateListener() {
        ...
        public void onCallStateChanged(int state, String phoneNumber) {
            Log.d(TAG, "상태: " + state + "전화번호: " + phoneNumber);
        }
...
//            Log.d(TAG, "방향 : " + direction);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (!checkPermissions()) {
            Toast.makeText(getApplicationContext(), "권한 설정을 해주셔야 앱이 정상 동작합니다.", Toast.LENGTH_LONG).show();
            return;
        }
    ...
    public void onBtn1Clicked(View v) {
        Intent intent = new Intent(Intent.ACTION_VIEW, Uri.parse("tel:114"));
